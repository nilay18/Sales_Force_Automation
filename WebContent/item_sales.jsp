...
<c:if test="${sessionScope.itemload== null}">
 ...
 <jsp:forward page="report?hidden=itemloadsales"></jsp:forward>
 </c:if>
												...
												<div class="widget-main no-padding">
													<form action="report">
														...
														<div class="form-actions center">
															...
															<input type="hidden" name = "hidden" value = "item_sales_display"/>
														</div>
													</form>
												</div>
											</div>
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<c:forEach items="${sessionScope.itemsales}" var="r">
														<tr>
														<td>${r.id }</td>
														<td>${r.iname }</td>
														<td>${r.quantity }</td>
