...
<c:if test="${sessionScope.itemload== null}">
 ...
 <jsp:forward page="report?hidden=itemloadorder"></jsp:forward>
 </c:if>
												...
												<div class="widget-main no-padding">
													<form action="report" >
														...
														<div class="form-actions center">
															...
															<input type="hidden" name = "hidden" value = "item_order_display"/>
														</div>
													</form>
												</div>
											</div>
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<c:forEach items="${sessionScope.itemorder}" var="r">
													<tr>
														<td>${r.iname }</td>
														<td>${r.quantity }</td>
														<td>${r.total_cost }</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="blue" href="report?hidden=detail_order&id=${r.id }">
													...
													<c:remove var="itemorder" scope="session"/>
