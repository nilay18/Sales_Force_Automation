...
<c:if test="${sessionScope.custload== null}">
   
 <jsp:forward page="report?hidden=custload"></jsp:forward>
 </c:if>
													...
													<form action="report" method="get">
														...
														<fieldset>
															...
															<select name="customer">
																...
																<c:forEach items="${sessionScope.custload}" var="r">
																<option><c:out value="${r.customer}"></c:out></option>
																</c:forEach>
																<c:remove var="custload" scope="session" />
														...
														<div class="form-actions center">
															...
															<input type="hidden" name = "hidden" value = "customer_sales_display"/>
														</div>
													</form>
												</div>
											</div>
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<c:forEach items="${sessionScope.custsales}" var="r">
														<tr>
														<td>${r.id }</td>
														<td>${r.iname }</td>
														<td>${r.quantity }</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="blue" href="report?hidden=detail_sales&id=${r.id }">
