					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<c:forEach items="${sessionScope.salesview}" var="r">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" >
										...
										<label class="col-sm-3 control-label no-padding-right">Customer</label>
											<div class="col-sm-9">
												<span class="input-icon">
													<input type="text" id="form-field-icon-1"  name="suppliers" value="<c:out value="${r.customer}"></c:out>" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
												<input type="text" id="form-field-icon-1" name="issuedate" value="<c:out value="${r.sdate}"></c:out>" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
												<input type="text" id="form-field-icon-1" name="quantity" value="<c:out value="${r.total_price}"></c:out>" disabled/>
									...
									<c:remove var="salesview" scope="session" />
