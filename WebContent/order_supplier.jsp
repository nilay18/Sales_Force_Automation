...
<c:if test="${sessionScope.suppload== null}">
 ...
 <jsp:forward page="report?hidden=suppload"></jsp:forward>
 </c:if>
												...
												<div class="widget-main no-padding">
													<form action="report">
														...
														<div class="form-actions center">
															...
															<input type="hidden" name = "hidden" value = "supplier_order_display"/>
														</div>
													</form>
												</div>
											</div>
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<c:forEach items="${sessionScope.supporder}" var="r">
																									<tr>
														<td>${r.iname }</td>
														<td>${r.quantity }</td>
														<td>${r.total_cost }</td>
													...
													<c:remove var="supporder" scope="session"/>
