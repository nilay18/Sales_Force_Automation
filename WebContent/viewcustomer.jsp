		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="page-header">
							...
							<c:forEach items="${sessionScope.customerview_detail}" var="r">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
												<input type="text" id="form-field-icon-1" placeholder="Customer, inc" name="customer" value="<c:out value="${r.customer}"></c:out>" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
												<textarea class="form-control" id="form-field-8" placeholder="Type billing address here" name="t1" disabled><c:out value="${r.baddress}"></c:out></textarea>
											</span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
												<input type="text" id="form-field-icon-1" placeholder="supplier@gmail.com" name="email" value="<c:out value="${r.fax}"></c:out>" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
												<textarea class="form-control" id="form-field-8" placeholder="Type shipping address here" name="t1" disabled><c:out value="${r.saddress}"></c:out></textarea>
											</span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
												<textarea class="form-control" id="form-field-8" placeholder="Type customer note here" name="t1" disabled><c:out value="${r.note}"></c:out></textarea>
											</span>
										</div>
									</div>
								...
								<c:remove var="customerview_detail" scope="session" />
